<script lang="ts">
  ...
  // Reference image preview — managed via $effect so the previous object URL is
  // revoked whenever the file changes or the component is torn down.
